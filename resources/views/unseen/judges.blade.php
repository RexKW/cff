        ...
        <div class = "col container padding">
            ...
            <div class = "row d-flex align-items-center align-middle border-bottom border-2 py-3 py-md-4">
                ...
                <div class = "col-12 col-md-8" data-aos = "fade-up" data-aos-duration = "1500">
                    <h1 class = "headline fs-min10 text-center text-md-start my-4"> Ifa Isfansyah </h1>
                    <p class = "fs-7 justify body-text"> Ifa Isfansyah merupakan seorang <i>director, producer, writer, </i> serta pendiri Jogja-NETPAC Asian Film Festival dan Jogja Film Academy. Film pendeknya "Half Teaspoon" (2007) memenangkan penghargaan untuk Film Pendek Asia Terbaik di Hongkong Independent Film-Video Awards 2008 dan dikomposisikan di International Film Festival Rotterdam 2008. Pada tahun 2022, beliau sukses menjadi produser dalam film “Before, Now, & Then (Nana)” yang berhasil memenangkan Film Cerita Panjang Terbaik pada Festival Film Indonesia. Pada tahun 2023 kemarin, beliau kembali hadir dengan filmnya yang  berjudul “Gadis Kretek” dan berhasil masuk dalam Busan International Film Festival (BIFF) 2023. </p>
                </div>
            </div>
            <div class = "row d-flex align-items-center align-middle border-bottom border-2 py-3 py-md-4">
                <div class = "col-12 col-md-8 order-md-1 order-2" data-aos = "fade-up" data-aos-duration = "1500">
                    <h1 class = "headline fs-min10 text-center text-md-start my-4"> Aryudha Fasha </h1>
                    <p class = "fs-7 justify body-text" data-aos = "fade-up"> Aryudha Fasha merupakan seorang aktor yang sudah menjelajahi berbagai karakter dan telah hadir dalam sejumlah <i>shorts, features, web series, public service announcements, commercial video,</i> and <i>music videos </i>. Kemampuan akting beliau sudah tidak perlu diragukan lagi karena beliau berhasil meraih penghargaan Aktor Terbaik di Bogor Independent Film Festival (BRIEFF) pada tahun 2022. Pada tahun 2023 kemarin, Aryudha Fasha membintangi sebuah web series yang berjudul “Tilik The Series” sebagai Nopek dan mendapatkan beberapa nominasi dalam Festival Film Bandung 2023. Pada tahun yang sama, beliau berhasil meraih Aktor Terbaik Layar Lokal 4 pada tahun 2023. Baru-baru ini, beliau kembali hadir dengan peran sebagai Toni dalam film “Mendung Tanpo Udan” (2024). </p>
                </div>
            ...
            <div class = "row d-flex align-items-center align-middle py-3 py-md-4">
                ...
                <div class = "col-12 col-md-8" data-aos = "fade-up" data-aos-duration = "1500">
                    <h1 class = "headline fs-min10 text-center text-md-start my-4"> Ginanti Rona </h1>
                    <p class = "fs-7 justify body-text"> Ginanti Rona memulai karirnya sebagai Assistant Director pada tahun 2009 dan bekerja sama dengan The Mo Brothers dan Gareth Evans di beberapa genre film. Film debutnya “Midnight Show” (2016) mendapatkan beberapa nominasi di festival film, yaitu Piala Maya untuk nominasi Debut Sutradara Film, Seleksi Resmi di Festival Film Horor Internasional; Strangers With My Face, Puerto Rico Horror Film Festival, dan Tokyo Scream Queen Film. <br>
