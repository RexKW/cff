        ...
        <div class = "col padding">
            ...
            <div class = "row d-flex align-items-center align-middle py-4 ">
                ...
                <div class = "col-12 col-md-8" data-aos = "fade-up" data-aos-duration = "1500">
                    <h1 class = "headline fs-min5B text-center text-md-start"> Rosihan Amril Farouq </h1>
                    <p class = "fs-7 body-text justify"> Rosihan Amril Farouqi, commonly known as Ukik, is an active 8th-semester Communication Studies student at Ciputra University. He is a writer and director of short films and commercials from Mojokerto, East Java. This 2021 batch student was also active in 2022 in establishing a film club at Ciputra University named Combine Films. Through Combine Films, he has been involved in organizing workshops, film screenings, discussions, and film distribution. Ukik has produced several short films, including "Gak Genah" (2020), where he served as director and writer; this film earned him Official Selection and Winner for Best Lead Actor nominations at the Klaten Film Festival 2021. Next is "Cinema Without Magic" (2021), where he was Assistant Director, which won Outstanding Achievement for Silent Movie at the World Film Carnival Singapore 2021. Another film, "Sliyut" (2022), where he was Executive Producer, received Official Selection and Best Super Short Film nomination at the Student World Impact Film Festival 2023 in the USA. Besides short films, he also produced an audiovisual public service announcement titled "Stop Rokok Ilegal" (Stop Illegal Cigarettes) for the Mojokerto KOMINFO office as director in 2021. During his studies, Ukik also served as Festival Director for the Ciputra Film Festival 2023-2024. </p>
                </div>
            </div>
            <div class = "row d-flex align-items-center align-middle py-4">
                <div class = "col-12 col-md-8 order-md-1 order-2" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "250">
                    <h1 class = "headline fs-min10 text-center text-md-start"> Wimar Herdanto </h1>
            ...
            <div class = "row d-flex align-items-center align-middle  py-4">
                ...
                <div class = "col-12 col-md-8" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "500">
                    <h1 class = "headline fs-min5B text-center text-md-start"> Bernard Realino Danu Kristianto  </h1>
            ...
            <div class = "row d-flex align-items-center align-middle  py-4">
                <div class = "col-12 col-md-8 order-md-1 order-2" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "250">
                    <h1 class = "headline fs-min10B text-center text-md-start"> Imanuel Deny Krisna Aji  </h1>
                    ...
                    <p class = "fs-7 body-text justify">Imanuel completed his undergraduate degree in 2013 at Gadjah Mada University Yogyakarta, majoring in Agricultural Extension and Communication. He then pursued a master's degree in Communication Science at Dr. Soetomo University from 2015 to 2017. Currently, he is continuing his doctoral studies at Sebelas Maret University.
                        He has also been entrusted as a curator for the Ciputra Film Festival editions “Arunika” and the 3rd Ciputra Film Festival “Unseen,” and this year he serves again as an Executive Board member for the 4th Ciputra Film Festival
                    </p>
                </div>
                <div class = "col-12 col-md-4 order-md-2 order-1" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "250">
            ...
            <div class = "row d-flex align-items-center align-middle  py-4">
                ...
                <div class = "col-12 col-md-8" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "500">
                    <h1 class = "headline fs-min5 text-center text-md-start"> Ignasius Liliek  </h1>
            ...
            <div class = "row d-flex align-items-center align-middle  py-4">
                <div class = "col-12 col-md-8 order-md-1 order-2" data-aos = "fade-up" data-aos-duration = "1500" data-aos-delay = "250">
                    <h1 class = "headline fs-min5B text-center text-md-start"> Louisa Christine Hartanto   </h1>
